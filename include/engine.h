...
public:
    struct Parameters {
        int cylinderBanks = 0;
        int cylinderCount = 0;
        int crankshaftCount = 0;
        int exhaustSystemCount = 0;
        int intakeCount = 0;
...
public:
    ...
    virtual Crankshaft *
    getOutputCrankshaft() const;

    virtual void setSpeedControl(
        double s);
    ...
    virtual double
    getIntakeFlowRate() const;

    virtual void update(
        double dt);

    virtual double
    getManifoldPressure() const;
    ...
    virtual double
    getTotalFuelMassConsumed() const;

    double
    getTotalVolumeFuelConsumed() const;

    inline double
    getStarterTorque() const
    {
        return m_starterTorque;
    }

    inline double
    getStarterSpeed() const
    {
        return m_starterSpeed;
    }
    ...
    inline double
    getDynoMinSpeed() const
    {
        return m_dynoMinSpeed;
    }

    inline double
    getDynoMaxSpeed() const
    {
        return m_dynoMaxSpeed;
    }

    inline double
    getDynoHoldStep() const
    {
        return m_dynoHoldStep;
    }

    inline int
    getFluidSimulationSteps() const
    {
    ...
    int getCylinderCount() const {
        return m_cylinderCount;
    }

    int getCrankshaftCount() const {
        return m_crankshaftCount;
    }

    int getExhaustSystemCount() const {
        return m_exhaustSystemCount;
    }

    int getIntakeCount() const {
        return m_intakeCount;
    }

    int getMaxDepth() const;

    Crankshaft *
    getCrankshaft(int i) const
    {
        return &m_crankshafts[i];
    }

    CylinderBank *
    getCylinderBank(int i) const
    {
        return &m_cylinderBanks[i];
    }
    ...
    Piston *
    getPiston(int i) const
    {
        return &m_pistons[i];
    }

    ConnectingRod *
    getConnectingRod(int i) const
    {
        return &m_connectingRods[i];
    }

    IgnitionModule *
    getIgnitionModule()
    {
        return &m_ignitionModule;
    }

    ExhaustSystem *
    getExhaustSystem(int i) const
    {
        return &m_exhaustSystems[i];
    }

    Intake *
    getIntake(int i) const
    {
        return &m_intakes[i];
    }

    CombustionChamber *
    getChamber(int i) const
    {
    ...
    createSimulator(
        ...
        int outputAudioSampleRate = 44100);
